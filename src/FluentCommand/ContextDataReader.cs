...
internal sealed class ContextDataReader : IDataReader, IDataReaderContext
{
    private readonly IDataReader _inner;

    public ContextDataReader(IDataReader inner, JsonSerializerOptions? jsonSerializerOptions)
    {
